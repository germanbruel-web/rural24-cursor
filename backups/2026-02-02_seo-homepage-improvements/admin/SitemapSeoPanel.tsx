    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
        ...
        <ul className="text-sm text-blue-800 space-y-1">
          <li>• Los avisos <strong>Premium</strong> y <strong>Destacados</strong> se agregan automáticamente al sitemap</li>
          <li>• Podés agregar manualmente cualquier aviso al sitemap</li>
          <li>• El sitemap se actualiza automáticamente cuando hay cambios</li>
          <li>• Ver sitemap actual: <a href="http://localhost:3001/sitemap.xml" target="_blank" rel="noopener noreferrer" className="underline">sitemap.xml</a></li>
        </ul>
      </div>
    </div>
  );
