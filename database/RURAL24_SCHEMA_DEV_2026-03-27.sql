...
\restrict patxSCZQdBJHslONAuMbS7U8Ah8NJqxjTxHstebfeQ8joG862KeUhYZ1qqfzkEo
...
--
-- Name: dequeue_emails(integer); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.dequeue_emails(p_limit integer DEFAULT 20) RETURNS TABLE(id uuid, type text, to_user_id uuid, to_email text, to_name text, payload jsonb, attempts integer)
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: enqueue_featured_activated_email(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enqueue_featured_activated_email() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
BEGIN
...
--
-- Name: enqueue_welcome_email(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.enqueue_welcome_email() RETURNS trigger
    LANGUAGE plpgsql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
DECLARE
...
--
-- Name: mark_email_failed(uuid, text); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.mark_email_failed(p_id uuid, p_error text) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
...
--
-- Name: mark_email_sent(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.mark_email_sent(p_id uuid) RETURNS void
    LANGUAGE sql SECURITY DEFINER
    SET search_path TO 'public'
    AS $$
  UPDATE public.email_queue
...
--
-- Name: set_email_templates_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--
...
--
-- Name: email_media; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.email_media (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    url text NOT NULL,
...
CREATE TABLE public.email_queue (
    ...
    CONSTRAINT email_queue_type_check CHECK ((type = ANY (ARRAY['featured_activated'::text, 'featured_expiring'::text, 'welcome'::text])))
);
...
--
-- Name: email_media email_media_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_media
    ADD CONSTRAINT email_media_pkey PRIMARY KEY (id);


--
-- Name: email_media email_media_public_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_media
    ADD CONSTRAINT email_media_public_id_key UNIQUE (public_id);
...
ALTER TABLE ONLY public.email_templates
    ADD CONSTRAINT email_templates_pkey PRIMARY KEY (type);
...
--
-- Name: idx_email_queue_failed; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_email_queue_failed ON public.email_queue USING btree (status, attempts) WHERE ((status = 'failed'::text) AND (attempts < 3));
...
--
-- Name: featured_ads trg_featured_activated_email; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_featured_activated_email AFTER UPDATE ON public.featured_ads FOR EACH ROW EXECUTE FUNCTION public.enqueue_featured_activated_email();
...
--
-- Name: users trg_welcome_email; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_welcome_email AFTER INSERT ON public.users FOR EACH ROW EXECUTE FUNCTION public.enqueue_welcome_email();
...
--
-- Name: email_queue email_queue_to_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.email_queue
    ADD CONSTRAINT email_queue_to_user_id_fkey FOREIGN KEY (to_user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
--
-- Name: email_media; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: onboarding_slides onboarding_slides_public_read; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY onboarding_slides_public_read ON public.onboarding_slides FOR SELECT USING ((is_active = true));


--
-- Name: onboarding_slides onboarding_slides_superadmin_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY onboarding_slides_superadmin_all ON public.onboarding_slides USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND ((users.role)::text = 'superadmin'::text)))));
...
--
-- Name: email_media service_role_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY service_role_all ON public.email_media TO service_role USING (true) WITH CHECK (true);


--
-- Name: email_templates service_role_all; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY service_role_all ON public.email_templates TO service_role USING (true) WITH CHECK (true);
...
\unrestrict patxSCZQdBJHslONAuMbS7U8Ah8NJqxjTxHstebfeQ8joG862KeUhYZ1qqfzkEo
