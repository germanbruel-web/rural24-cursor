...
-- Generado: 2026-03-28T19:56:11.614Z
-- Fuente: DEV (Staging)
...
\restrict Zx7PuAlT0UjNgt5BQbBeHGUbwqSP2BqDgz0hekLNi2bKTGd4qxaCmRIgp3G1AK8
...
CREATE TABLE public.users (
    ...
    piso_dpto character varying(20),
...
--
-- Name: notify_featured_expiring_soon(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.notify_featured_expiring_soon() RETURNS integer
    LANGUAGE plpgsql SECURITY DEFINER
    AS $$
DECLARE
  v_count INT := 0;
...
CREATE TRIGGER trg_update_profile_completion BEFORE INSERT OR UPDATE OF email_verified, mobile, full_name, province, location, calle, altura, avatar_url ON public.users FOR EACH ROW EXECUTE FUNCTION public.update_profile_completion();
...
\unrestrict Zx7PuAlT0UjNgt5BQbBeHGUbwqSP2BqDgz0hekLNi2bKTGd4qxaCmRIgp3G1AK8
