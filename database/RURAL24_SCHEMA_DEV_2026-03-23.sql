...
\restrict qu05F1hRJs626lZJdKYOR4UG5UPaTwapE2rDlCqq3LhanrbDPgi5KMlVhSq3QzI
...
--
-- Name: FUNCTION get_ad_contact_status(p_user_id uuid, p_ad_id uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_ad_contact_status(p_user_id uuid, p_ad_id uuid) IS 'Retorna estado de contacto (available/pending/replied) de un usuario para un aviso específico';
...
CREATE TABLE public.home_sections (
    ...
    type text NOT NULL,
    title text NOT NULL,
    query_filter jsonb DEFAULT '{}'::jsonb NOT NULL,
...
--
-- Name: COLUMN home_sections.type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN home_sections.query_filter; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN home_sections.display_config; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN home_sections.active_schedule; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: get_home_composition(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.get_home_composition() RETURNS SETOF public.home_sections
    LANGUAGE sql STABLE SECURITY DEFINER
    AS $$
  SELECT *
...
--
-- Name: FUNCTION get_or_create_chat_channel(p_ad_id uuid, p_buyer_id uuid, p_seller_id uuid); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.get_or_create_chat_channel(p_ad_id uuid, p_buyer_id uuid, p_seller_id uuid) IS 'Crea o retorna canal existente. Plan FREE: máx 3 canales como comprador';
...
--
-- Name: FUNCTION mask_sensitive_chat_content(); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.mask_sensitive_chat_content() IS 'Enmascara datos de contacto y links externos antes de guardar el mensaje';
...
--
-- Name: FUNCTION notify_chat_message_received(); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.notify_chat_message_received() IS 'Inserta notificación in-app al receptor cuando tenía 0 mensajes sin leer';
...
--
-- Name: set_home_sections_updated_at(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.set_home_sections_updated_at() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
  NEW.updated_at = now();
...
--
-- Name: _rural24_migrations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public._rural24_migrations (
    filename text NOT NULL,
    applied_at timestamp with time zone DEFAULT now() NOT NULL,
    applied_by text DEFAULT 'migration-script'::text
);
...
CREATE TABLE public.banners_clean (
    ...
    desktop_image_meta jsonb,
    mobile_image_meta jsonb,
    carousel_image_meta jsonb,
...
--
-- Name: COLUMN banners_clean.desktop_image_meta; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN banners_clean.mobile_image_meta; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN banners_clean.carousel_image_meta; Type: COMMENT; Schema: public; Owner: -
--
...
COMMENT ON TABLE public.chat_channels IS 'Canal P2P por aviso: un comprador solo puede abrir un canal por aviso';


--
-- Name: COLUMN chat_channels.buyer_unread; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN chat_channels.seller_unread; Type: COMMENT; Schema: public; Owner: -
--
...
COMMENT ON TABLE public.chat_messages IS 'Mensajes dentro de un canal de chat P2P';


--
-- Name: COLUMN chat_messages.was_masked; Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON COLUMN public.chat_messages.was_masked IS 'true si el mensaje fue modificado por el filtro de contenido sensible';
...
--
-- Name: _rural24_migrations _rural24_migrations_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public._rural24_migrations
    ADD CONSTRAINT _rural24_migrations_pkey PRIMARY KEY (filename);
...
--
-- Name: idx_banners_clean_carousel_meta; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_banners_clean_carousel_meta ON public.banners_clean USING gin (carousel_image_meta);


--
-- Name: idx_banners_clean_desktop_meta; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_banners_clean_desktop_meta ON public.banners_clean USING gin (desktop_image_meta);
...
--
-- Name: idx_banners_clean_mobile_meta; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_banners_clean_mobile_meta ON public.banners_clean USING gin (mobile_image_meta);
...
--
-- Name: idx_home_sections_sort; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_home_sections_sort ON public.home_sections USING btree (sort_order) WHERE (is_active = true);


--
-- Name: idx_home_sections_type; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_home_sections_type ON public.home_sections USING btree (type) WHERE (is_active = true);
...
--
-- Name: home_sections trg_home_sections_updated_at; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER trg_home_sections_updated_at BEFORE UPDATE ON public.home_sections FOR EACH ROW EXECUTE FUNCTION public.set_home_sections_updated_at();
...
--
-- Name: _rural24_migrations; Type: ROW SECURITY; Schema: public; Owner: -
--
...
--
-- Name: home_sections home_sections_select_public; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY home_sections_select_public ON public.home_sections FOR SELECT USING (true);


--
-- Name: home_sections home_sections_write_superadmin; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY home_sections_write_superadmin ON public.home_sections USING ((EXISTS ( SELECT 1
   FROM public.users
  WHERE ((users.id = auth.uid()) AND ((users.role)::text = 'superadmin'::text)))));
...
\unrestrict qu05F1hRJs626lZJdKYOR4UG5UPaTwapE2rDlCqq3LhanrbDPgi5KMlVhSq3QzI
