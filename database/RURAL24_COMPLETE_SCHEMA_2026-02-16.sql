...
\restrict hAEHGLNcda0gw5EtjblCUs9R5ZW8QEaSnTjzAwbywhsMQliRfXaQHt3QAyHXpp5
...
BEGIN
  ...
  -- 6. Crear featured ad
  --    SuperAdmin: is_manual=true, status='active', sin expiración
  --    Usuario:    is_manual=false, status='pending', con expiración
...
--
-- Name: FUNCTION create_featured_ad(p_ad_id uuid, p_user_id uuid, p_placement character varying, p_scheduled_start date); Type: COMMENT; Schema: public; Owner: -
--

COMMENT ON FUNCTION public.create_featured_ad(p_ad_id uuid, p_user_id uuid, p_placement character varying, p_scheduled_start date) IS 'Crea un featured ad con verificación de rol. SuperAdmin no consume créditos.
Args:
...
--
-- Name: increment_coupon_redemptions(uuid); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.increment_coupon_redemptions(coupon_uuid uuid) RETURNS void
    LANGUAGE plpgsql
    AS $$
BEGIN
  UPDATE coupons
...
\unrestrict hAEHGLNcda0gw5EtjblCUs9R5ZW8QEaSnTjzAwbywhsMQliRfXaQHt3QAyHXpp5
