    ...
    <aside className="w-full md:w-64 lg:w-72 bg-white p-6 rounded-lg shadow-md sticky top-4">
          ...
          {options.categories.map(category => (
            <div key={category} className="flex items-center mb-2">
              <input 
                ...
                className="h-4 w-4 rounded border-gray-300 text-[#16a135] focus:ring-[#16a135]" 
              />
      ...
      <div className="mb-6">
        ...
        <select 
          ...
          className="w-full p-2 border border-gray-300 rounded-md focus:ring-[#16a135] focus:border-[#16a135]"
        >
      ...
      <div className="space-y-2">
        <button
          ...
          className="w-full px-4 py-3 bg-[#16a135] text-white rounded-lg hover:bg-[#0e7d25] transition-colors font-semibold"
        >
          Aplicar Filtros
        </button>
        <button
