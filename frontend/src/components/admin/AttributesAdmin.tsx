      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 bg-white rounded-xl border-2 border-gray-200">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all disabled:bg-gray-100 disabled:cursor-not-allowed"
          >
        ...
        <div className="p-6 bg-white rounded-xl border-2 border-gray-200 space-y-6">
              ...
              {(formData.field_options || []).length > 0 && (
                <div className="flex flex-wrap gap-2 p-4 bg-gray-50 rounded-xl border-2 border-gray-200">
                  {(formData.field_options || []).map((option) => (
                    <div
                      key={option}
                      className="flex items-center gap-2 px-3 py-2 bg-green-100 text-green-800 rounded-lg text-sm font-medium"
                    >
                      <span>{option}</span>
                      <button
                        onClick={() => removeOption(option)}
                        className="hover:bg-green-200 rounded p-0.5 transition-all"
                        type="button"
                      >
                        <X className="w-4 h-4" />
                      </button>
              ...
              {!showBulkMode && (
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all"
                  />
                  <button
                    onClick={addOption}
                    type="button"
          ...
          <div className="flex gap-3 pt-4 border-t-2 border-gray-100">
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 px-6 py-3 bg-green-500 text-white rounded-xl hover:bg-green-600 transition-all font-semibold disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-green-500 focus:ring-4 focus:ring-green-100 transition-all resize-none"
                />
              </div>
            </div>
