    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl max-w-6xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="bg-white border-b border-gray-200 p-6 flex items-center justify-between">
          ...
          <button onClick={onClose} className="text-gray-500 hover:bg-gray-100 p-2 rounded-lg transition">
            <X className="w-6 h-6" />
          </button>
        </div>
          ...
          {!result ? (
            <>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6">
                ...
                <div className="bg-white rounded p-3 font-mono text-sm mb-3 overflow-x-auto border border-gray-200">
                  <pre className="text-gray-700">{columnConfig.example}</pre>
                </div>
                <div className="flex gap-2">
                  <button
                    onClick={downloadTemplate}
                    className="text-sm bg-white text-gray-700 px-3 py-1.5 rounded-lg border border-gray-300 hover:bg-gray-50 transition flex items-center gap-2"
                  >
                  ...
                  <div className="text-sm text-gray-600 flex items-center gap-2">
                    ...
                    Separa columnas con TAB o comas
                  </div>
                </div>
              </div>
                ...
                <div>
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <div className="flex gap-3">
                      <div className="flex items-center gap-2 text-brand-600 bg-brand-50 px-3 py-1.5 rounded-lg">
            ...
            <div className="text-center py-12">
              <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-6 ${
                ...
                <CheckCircle className={`w-10 h-10 ${
                  result.errors.length === 0 ? 'text-brand-600' : 'text-yellow-600'
                }`} />
              </div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Se importaron <span className="font-bold text-brand-600">{result.success}</span> registros exitosamente
              </p>
