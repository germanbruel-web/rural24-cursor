    ...
    return (
      <div className="mt-4">
        <a
          ...
          className="block w-[280px] h-[250px] bg-gradient-to-br from-brand-600 to-brand-700 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all hover:scale-[1.02] flex flex-col items-center justify-center"
        >
