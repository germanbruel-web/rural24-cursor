...
import { DocumentTextIcon, InformationCircleIcon, Cog6ToothIcon, CheckBadgeIcon } from '@heroicons/react/24/outline';
  ...
  const handleContactSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await sendContactMessage({
        ...
        sender_user_id: user.id, // ✅ Ahora obligatorio
      ...
      <div id="ad-detail-content" className="max-w-7xl mx-auto px-4 py-6">
        <div id="ad-detail-grid" className="grid lg:grid-cols-3 gap-8">
          ...
          <div id="ad-left-column" className="lg:col-span-2 space-y-6">
            ...
            <div id="ad-description" className="bg-white rounded-xl shadow-md p-4 sm:p-6 border-l-4 border-green-600">
                    ...
                    return (
                      <>
                        {Object.entries(grouped).map(([groupKey, attrs]) => (
                          <div key={groupKey} className="bg-white rounded-xl shadow-md p-4 sm:p-6 border-l-4 border-green-600">
                            <h3 className="text-base font-bold text-gray-900 mb-4 flex items-center gap-2">
              ...
              {ad.seller ? (
                <>
                  ...
                  {!showContactForm ? (
                    ...
                    <div id="contact-success-modal" className="space-y-3">
                      {contactSuccess ? (
                        <div className="bg-white border-2 border-green-500 rounded-lg p-6 text-center shadow-lg">
                          <div className="mb-4">
                          ...
                          <button
                            ...
                            className="w-full bg-[#16a135] text-white px-6 py-3 rounded-lg text-base font-semibold hover:bg-[#0e7d25] transition-colors"
                          >
                            {TEXTS.common.close}
                          </button>
                        ...
                        <form id="contact-form" onSubmit={handleContactSubmit} className="space-y-3">
                          {user && (
                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3 text-sm text-blue-800">
                              ✅ {TEXTS.adDetail.sendingAs} <strong>{user.email}</strong>
                            </div>
                          )}
                          <input 
                            type="text" 
                            ...
                            readOnly={!!user}
                            className={`w-full px-3 py-2 border rounded-lg ${user ? 'bg-gray-100' : ''}`}
                          />
                          <input 
                            type="text" 
                            required 
                          ...
                          <div className="flex gap-2">
                            ...
                            <button 
                              ...
                              className="flex-1 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors disabled:bg-gray-300"
                            >
                ...
                <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg text-center">
                  <p className="text-sm text-blue-800">
                    ℹ️ {TEXTS.adDetail.externalSource}
                  </p>
                </div>
              )}
