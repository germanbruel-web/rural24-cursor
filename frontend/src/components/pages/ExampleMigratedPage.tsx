          ...
          {[1, 2, 3, 4, 5, 6, 7, 8].map((item) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <div className="flex items-center justify-between mb-4">
                  <p className="text-lg sm:text-xl font-bold text-brand-600 dark:text-green-400">
                    USD 45,000
                  </p>
      ...
      <section className="max-w-2xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 sm:p-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              rows={4}
              className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-brand-600 dark:bg-gray-700 dark:text-white"
