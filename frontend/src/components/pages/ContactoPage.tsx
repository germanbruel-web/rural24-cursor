...
import {
  Mail, MessageCircle, Instagram, MapPin, Clock,
  Headphones, Lightbulb, Megaphone, Loader2, CheckCircle2, ImagePlus, Trash2,
} from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-brand-50">
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        {/* ===== CANALES DE CONTACTO ===== */}
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Otros canales</h2>
          <div className="space-y-4">

            <a href="mailto:hola@rural24.com.ar" className="bg-white rounded-xl border border-gray-200 p-5 flex items-start gap-4 hover:border-brand-400 hover:shadow-md transition-all">
              <div className="w-11 h-11 bg-brand-600 rounded-full flex items-center justify-center shrink-0">
                <Mail className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-0.5">Correo electrónico</h3>
            ...
            <a href="https://wa.me/5492615000000" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-gray-200 p-5 flex items-start gap-4 hover:border-brand-400 hover:shadow-md transition-all">
              <div className="w-11 h-11 bg-brand-600 rounded-full flex items-center justify-center shrink-0">
                <MessageCircle className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-0.5">WhatsApp</h3>
            ...
            <a href="https://instagram.com/rural24ar" target="_blank" rel="noopener noreferrer" className="bg-white rounded-xl border border-gray-200 p-5 flex items-start gap-4 hover:border-brand-400 hover:shadow-md transition-all">
              <div className="w-11 h-11 bg-brand-600 rounded-full flex items-center justify-center shrink-0">
                <Instagram className="w-5 h-5 text-white" />
              </div>
              <div>
                <h3 className="font-semibold text-gray-900 mb-0.5">Instagram</h3>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-0.5">Horario de atención</h3>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-5 flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900 mb-0.5">Origen</h3>
                <p className="text-gray-700 text-sm">Mendoza, Argentina</p>
                <p className="text-gray-500 text-xs mt-0.5">Somos un equipo 100% argentino especializado en el sector agropecuario.</p>
              </div>
            </div>
